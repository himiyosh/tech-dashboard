...
| 領域 | 仕組み | 頻度 / トリガ |
|---|---|---|
| データ収集 + Queue 要約 + og:image | Cloudflare Worker cron + `worker-summarizer` Queue consumer | 毎時 (50 sources を 4 batch ローテーション、要約は最大 10 件/run を Queue 投入) |
