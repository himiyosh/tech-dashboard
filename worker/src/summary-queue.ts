 ...
 * (titleJa + summaryJa + summaryEn). The long-form body is filled
 * deterministically by the collector (R-012/R-013) and is never generated by
 * the queue. So "needs generation" must mean "lacks a real bilingual summary",
...
export function needsGeneratedContent(
  entry: Pick<NormalizedEntry, "summaryJa" | "summaryEn">,
): boolean {
